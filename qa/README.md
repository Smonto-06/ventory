...
| `qa-4-plan-ui.js` | Catálogos, ajustes, IVA, plan comercial, super admin (notas privadas, registro de actividad), prueba repetida por IP, recorrido de la interfaz | 41 |
