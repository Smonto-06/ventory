...
## Qué cubre — 451 pruebas

| Archivo | Área | Pruebas |
|---|---|---|
| `qa-1-seguridad.js` | Aislamiento entre negocios, permisos por rol (cajero, encargado, admin), eliminar empleados y productos (API y desde la interfaz), sesión activa no bloquea /register, acceso sin sesión | 40 |
...
| `qa-4-plan-ui.js` | Catálogos, ajustes, IVA, plan comercial, super admin (notas privadas, registro de actividad), prueba repetida por IP, filtro de stock bajo desde el Panel, editar precio de un artículo en el carrito, recorrido de la interfaz | 44 |
